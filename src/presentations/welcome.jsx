...
module.exports = {
	...
	slides: [
		<ImageAside image={imageURL('right-arrow.png')} color="#fff" bg="#0d1f3c">
		...
		<WashedBgImage color={CBLUE} image={imageURL('world-thumb.png')}>
			<div style={{padding: '0 1em'}}>
				<p className="lineCaption small" style={{borderColor: CRED}}>AUDITORIUMへようこそ<br/>WELCOME TO THE AUDITORIUM</p>
				<p className="center"><img src={imageURL('ctrl-overview.png')} style={{width: '480px'}} /></p>
				<p className="center">
		...
		<WashedBgImage color={CBLUE} image={imageURL('world-thumb.png')}>
			<div style={{padding: '0 1em'}}>
				<p className="lineCaption small" style={{borderColor: CRED}}>AUDITORIUMへようこそ<br/>WELCOME TO THE AUDITORIUM</p>
				<p className="center"><img src={imageURL('ctrl-overview-left-right.png')} style={{width: '480px'}} /></p>
				<p className="center">
		...
		<WashedBgImage color={CBLUE} image={imageURL('world-thumb.png')}>
			<div style={{padding: '0 1em'}}>
				<p className="lineCaption small" style={{borderColor: CRED}}>AUDITORIUMへようこそ<br/>WELCOME TO THE AUDITORIUM</p>
				<p className="center"><img src={imageURL('ctrl-overview-menu.png')} style={{width: '480px'}} /></p>
				<p className="center">
		...
		<WashedBgImage color={CBLUE} image={imageURL('world-thumb.png')}>
			<div style={{padding: '0 1em'}}>
				<p className="lineCaption small" style={{borderColor: CRED}}>AUDITORIUMへようこそ<br/>WELCOME TO THE AUDITORIUM</p>
				<p className="center"><img src={imageURL('menu.gif')} style={{width: '50%'}} /></p>
				<p className="center">
		...
		<WashedBgImage color={CBLUE} image={imageURL('world-thumb.png')}>
			<div style={{padding: '0 1em'}}>
				...
				<p className="center">
					<img src={imageURL('ctrl-reload.png')} style={{height: '350px'}} />
				</p>
				<p className="center">
		...
		<WashedBgImage image={imageURL('world-release.png')} color={CBLUE}>
			<div style={{padding: '1em'}}>
				...
				<p className="center large">
					<img src={imageURL('beanow.png')} style={{height: '128px', borderRadius: '128px', verticalAlign: 'middle'}} />
					&nbsp; Beanow#5887
				</p>
			</div>
		</WashedBgImage>
